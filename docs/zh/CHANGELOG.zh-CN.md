...
- 让已安装的 skill 副本通过 `.skill-source-dir` 记录来源 checkout
- 修复 `update-local-skill.sh`，使其从已安装副本执行时会回到记录的来源 checkout 刷新，而不是删掉自己的源目录
- 增加已安装副本更新路径的回归测试

### 变更

- 更新安装、onboarding 和 release 文档，说明基于记录来源路径的刷新行为
