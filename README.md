...
| `codex-agent-worktree-setup` | You need Codex-visible agents tied to isolated branch worktrees | new Codex threads, branch-bound worktrees, detached HEAD repair, main protection | [Skill](codex-agent-worktree-setup/SKILL.md) |
