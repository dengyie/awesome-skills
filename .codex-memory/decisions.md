...
- Impact: The package now records the active asset track more explicitly in provenance, mock-pass, and memory artifacts.
- Rollback trigger: If downstream projects show the new asset-level fields are too heavy for simple sites, trim low-value wording while preserving route-family ownership, readiness limiter, and blocker ownership.
- Related files: `docs/dev/2026-06-18-zero-to-website-design-v16-asset-authority-handoff-plan.md`, `zero-to-website-design/references/visual-provenance.md`, `zero-to-website-design/references/historical-mock-pass.md`, `zero-to-website-design/references/project-memory-integration.md`, `zero-to-website-design/assets/templates/visual-source-map.md`, `zero-to-website-design/assets/templates/visual-source-inventory.md`, `zero-to-website-design/assets/templates/mock-asset-pass.md`
## 2026-06-18 - Next Hardening Should Move Down To Asset-Level Authority Continuity
- Decision: After V15, target the asset-level authority and handoff contract as V16 by tightening the visual source map, source inventory, mock-asset pass, and related guidance.
- Rationale: The workflow now has strong pre-code, route-level, content, metadata, QA, and delivery contracts, but the asset-level artifacts still under-record route ownership slices, active upgrade queues, and asset-specific QA/handoff state. That is the clearest remaining place where another session could still reconstruct too much from chat.
- Impact: The next stage will turn asset provenance artifacts into stronger resumable records for temporary-binding upgrades, route ownership scope, and pending asset verification.
- Rollback trigger: If downstream projects prove the new asset-level fields too heavy for simple sites, keep route ownership, upgrade queue, and blocker ownership while trimming lower-value phrasing.
- Related files: `docs/dev/2026-06-18-zero-to-website-design-v16-asset-authority-handoff-plan.md`, `zero-to-website-design/references/visual-provenance.md`, `zero-to-website-design/references/historical-mock-pass.md`, `zero-to-website-design/references/project-memory-integration.md`, `zero-to-website-design/assets/templates/visual-source-map.md`, `zero-to-website-design/assets/templates/visual-source-inventory.md`, `zero-to-website-design/assets/templates/mock-asset-pass.md`
