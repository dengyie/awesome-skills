...
- [x] Close `split-image-assets` work-item recommendation bundle V1: shared bundle helper adoption, focused bundle tests, canonical plan sync, and regression coverage.
...
- [x] Close `split-image-assets` provider work-item schema V1: structured provider recommendation variants/task grouping, docs, canonical plan sync, and regression coverage.
- [x] Close `split-image-assets` candidate lifecycle task schema V1: grouped recommended_task surface, richer variant transition metadata, docs, canonical plan sync, and regression coverage.
...
- [x] Close `split-image-assets` promotion approval runtime guard V1: runtime candidate-promotion confirmation enforcement, promotion fixture sync, docs, canonical plan sync, and regression coverage.
- [x] Close `split-image-assets` candidate promotion approval handoff V1: candidate-promotion gate-aware candidate work items, approval command handoff, docs, canonical plan sync, and regression coverage.
- [x] Close `split-image-assets` compare-selected promotion defaults V1: comparison-owned selected candidate/selection reason reuse, candidate work-item command sync, docs, canonical plan sync, and regression coverage.
...
- [x] Close `split-image-assets` provider-aware compare promotion defaults V1: generated compare auto-discovery, single-candidate compare-driven promotion defaults, docs, canonical plan sync, and regression coverage.
